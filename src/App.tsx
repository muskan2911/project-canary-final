...
import TrackCasesPage from './components/TrackCasesPage';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="flex items-center justify-between p-4 bg-gray-100">
        <h1 className="text-2xl font-bold">Project Canary Dashboard</h1>
        <button
      ...
      <Routes>
          ...
          <div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatCard
                  title="Total Cases"
                  value={statsLoading || !stats ? 0 : stats.total_cases}
                  icon={FileText}
                  color="bg-blue-600"
                ...
                <StatCard
                  title="High Priority"
                  value={statsLoading || !stats ? 0 : stats.high_priority}
                  icon={AlertCircle}
                  color="bg-orange-600"
                ...
                <StatCard
                  title="Incidents"
                  value={statsLoading || !stats ? 0 : stats.incidents}
                  icon={AlertCircle}
                  color="bg-red-600"
                ...
                <StatCard
                  title="Open Cases"
                  value={statsLoading || !stats ? 0 : stats.open_cases}
                  icon={FolderOpen}
                  color="bg-green-600"
        ...
        <Route path="/track/:trackId" element={<TrackCasesPage />} />
      </Routes>
    </div>
  );
}
